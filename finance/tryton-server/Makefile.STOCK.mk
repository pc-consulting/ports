...
PRODUCTLOCATIONPLACE_DESC=		Defines fixed place of products per location.
PRODUCTLOCATIONPLACE_RUN_DEPENDS=	${PYTHON_PKGNAMEPREFIX}trytond-stock-product-location-place>=${TRYTON_MIN_VERSION}<${TRYTON_MAX_VERSION}:finance/py-trytond-stock-product-location-place@${PY_FLAVOR}
