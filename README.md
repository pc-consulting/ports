...
- finance/py-tryton*
    ...
    - finance/py-trytond-account*
        ...
        - Passing portlint, and (if applicable) with complete tryton.cfg dependencies in Makefile: py-proteus
        - Passing portlint, and with partial tryton.cfg dependencies in Makefile: py-trytond-account, py-trytond-company
