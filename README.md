...
- finance/tryton*
    ...
    - finance/trytond-account*
        ...
        - As-created by pytoport, not usable yet: trytond-account, trytond-account-asset, trytond-account-be, trytond-account-budget, py-trytond-account-cash-rounding, trytond-account-consolidation, trytond-account-credit-limit, trytond-account-deposit
- ports-mgmt/pytoport
