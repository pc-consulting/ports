...
- finance/py-tryton*
    ...
    - finance/py-trytond-account*
        ...
        - Passing portlint, and (if applicable) with complete tryton.cfg dependencies in Makefile: py-proteus, py-trytond-account, py-trytond-analytic-account, py-trytond-company, py-trytond-company-work-time, py-trytond-country, py-trytond-currency, py-trytond-gis, py-trytond-party, py-trytond-timesheet
