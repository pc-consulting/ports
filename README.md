...
- devel/arduino-ide
  ...
  Arduino IDE of the more recent (than what we had in ports so far) v2.x branch including several dependencies the IDE requires apart from what already is present in ports.
- comms/py-gpiofbsd
