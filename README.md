...
- finance/tryton*
    ...
    - finance/trytond-account*
        ...
        - As-created by pytoport, not usable yet: trytond-account, trytond-account-asset, trytond-account-be, trytond-account-budget, py-trytond-account-cash-rounding
- ports-mgmt/pytoport
